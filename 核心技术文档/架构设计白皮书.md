...
![77581b7cbeaf69b568402a299e1d39ac](架构设计白皮书.assets/77581b7cbeaf69b568402a299e1d39ac.png)
...
## 9. 最新一致性更新（2025/12/04）

- 聊天快捷话术精简为 3 项（总结/润色/翻译），ChipGroup 改为居中包裹布局，保持均匀分布。
- 顶部功能栏（菜单/设置/新对话）视觉微调：`layout_marginTop` 现为 12dp，以适配实际设备上的观感。
- 文档与部署指南已同步：图标替换仍走 Image Asset；云端部署章节新增 PID 查找与安全关停步骤。
