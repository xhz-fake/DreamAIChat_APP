...
> 本章按“小白模式”写：只假设你手里有一堆 PNG 图片，没有 SVG、不会写 XML，也不了解各种 density 的概念。只要跟着步骤做，就能把 APP 里的图标全部换成你自己的。
...
| --- | --- | --- | --- | --- |
| `ic_attach` | `drawable/` | 输入框“图片”按钮 | `fragment_chat.xml` | 小图标，24dp，适合用简单 PNG |
